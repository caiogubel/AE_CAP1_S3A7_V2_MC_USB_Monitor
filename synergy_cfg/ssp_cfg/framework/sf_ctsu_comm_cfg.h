...
#ifndef SF_CTSU_COMM_CFG_H_
#define SF_CTSU_COMM_CFG_H_
#define SF_CTSU_COMM_CFG_PARAM_CHECK      (BSP_CFG_PARAM_CHECKING_ENABLE)
...
#define SF_CTSU_COMM_CFG_CONNECTION       (1)

#define SF_CTSU_COMM_CFG_THREAD_PRIORITY  (1)
